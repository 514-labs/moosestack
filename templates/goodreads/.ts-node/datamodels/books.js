...
exports.BooksPipeline = void 0;
var typia_1 = __importDefault(require("typia"));
var moose_lib_1 = require("@514labs/moose-lib");
exports.BooksPipeline = new moose_lib_1.IngestPipeline(
  "books",
  {
    table: {
    ...
    stream: true,
    ingest: {
      format: moose_lib_1.IngestionFormat.JSON,
    },
  },
  {
    version: "3.1",
