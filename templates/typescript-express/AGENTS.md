...
MooseStack TypeScript project with Express API framework.
...
| File | Purpose |
| --- | --- |
| `app/ingest/models.ts` | Data models (interfaces + pipeline declarations) |
| `app/apis/*.ts` | Express API endpoints (WebApp) |
