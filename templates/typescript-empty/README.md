# This is a [MooseJs](https://docs.fiveonefour.com/moosestack) project bootstrapped with the [`Moose CLI`](https://github.com/514-labs/moosestack/tree/main/apps/framework-cli).
