...
const SEMANTIC_TOOL_TITLES = {
  query_tenant_knowledge_metrics: "Knowledge Metrics",
  list_tenant_knowledge_records: "Knowledge Records",
} as const;
...
export type SemanticToolName = keyof typeof SEMANTIC_TOOL_TITLES;
...
export function getSemanticToolTitle(toolName: SemanticToolName): string {
  return SEMANTIC_TOOL_TITLES[toolName];
}
