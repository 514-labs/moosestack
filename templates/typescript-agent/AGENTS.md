...
| `src/dev/` | Development-only local identities and mock guardrails |
...
| `MOOSE_AUTH_MODE` | `packages/web-app/.env.local` | `local` for the built-in local identities, `oidc` for external OIDC |
