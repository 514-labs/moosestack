...
from moose_lib import Key, IngestPipeline, IngestPipelineConfig, StringToEnumMixin, Point
...
class Foo(BaseModel):
    ...
    location: Optional[Point] = None  # Optional geo location (longitude, latitude)
...
class Bar(BaseModel):
    ...
    has_text: bool
    text_length: int
    location: Optional[Point] = None  # From Foo.location
