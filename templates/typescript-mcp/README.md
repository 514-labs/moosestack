...
You can configure Claude Code to connect to this custom MCP server using either the CLI command or a configuration file.
...
Create or update your `mcp.json` configuration file (typically located at `~/.claude/mcp.json` or in your project root):
