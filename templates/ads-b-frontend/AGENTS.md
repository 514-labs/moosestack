...
| File | Purpose |
| --- | --- |
| `moose/app/datamodels/models.ts` | Backend data models (aircraft transponder data) |
| `moose/app/functions/process_aircraft.ts` | Aircraft data processing logic |
| `moose/moose.config.toml` | Moose port and service configuration |
| `frontend/src/app/` | Next.js app directory |
| `frontend/package.json` | Frontend dependencies (React, Next.js, Radix UI, recharts) |
