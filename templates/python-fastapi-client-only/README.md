# FastAPI Client-Only Template

A Python FastAPI-based Moose template for building analytical backend services with ClickHouse. This is a client-only template that uses MooseStack libraries in FastAPI without requiring the Moose runtime.
