...
- **Add support for custom TypeScript web frameworks in consumption APIs**
  ...
  **Express WebApp with MooseStack data integration**
  ...
  Shows how to create a custom Express.js web application that integrates with MooseStack data pipelines. The WebApp can query ClickHouse data, provide health checks, and handle complex analytics requests while being mounted at a custom path (/dashboard) alongside the standard MooseStack APIs.
