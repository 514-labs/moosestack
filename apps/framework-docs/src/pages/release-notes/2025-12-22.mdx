...
PR: [#3137](https://github.com/514-labs/moosestack/pull/3137)
...
- **Improved documentation code block behavior** – Updated documentation site to make code block animations opt-in rather than automatic, providing a cleaner reading experience. Code blocks now remain static by default and only animate when explicitly requested with the 'animate' attribute. [#3139](https://github.com/514-labs/moosestack/pull/3139)
- **Improved stream configuration documentation with clearer examples** – Enhanced the stream configuration documentation by separating parallelism and retention period into distinct sections with clearer explanations. Added better context about performance trade-offs for parallelism and storage implications for retention periods, making it easier for users to configure streams appropriately. [#3119](https://github.com/514-labs/moosestack/pull/3119)
- **Improved data modeling documentation structure** – Reorganized the data modeling documentation by promoting "Problem" and "Solution" sections to top-level headings, making it easier for users to understand the core concepts and benefits of Moose's data modeling approach. [#3144](https://github.com/514-labs/moosestack/pull/3144)
- **Improved migration documentation with comprehensive guides and troubleshooting** – Added extensive documentation for Moose's migration system, including detailed guides for CLI migrations, automatic migrations, planned migrations, and troubleshooting failed migrations. This helps users better understand and manage database schema changes in their data pipelines. [#3136](https://github.com/514-labs/moosestack/pull/3136)
...
- **Added detailed documentation for all ClickHouse data types and table engines** – Added detailed documentation for all ClickHouse data types (arrays, booleans, decimals, datetime, strings, etc.) and table engines (MergeTree variants, distributed engines, S3 integrations). Users can now reference complete type mapping guides and engine configuration examples when building data models. [#3134](https://github.com/514-labs/moosestack/pull/3134)
