...
- **Arbitrary JSON fields in ingest APIs** – Accept payloads with extra fields beyond your schema; extras land in a JSON column for flexible schema evolution. PR [#3047](https://github.com/514-labs/moosestack/pull/3047) | [Data models](/moose/data-models)
...
- **Next.js client-only mode (experimental)** – Set `MOOSE_CLIENT_ONLY=true` to import Moose data models without runtime, fixing HMR errors. PR [#3057](https://github.com/514-labs/moosestack/pull/3057) | [API Frameworks](/moose/app-api-frameworks)
