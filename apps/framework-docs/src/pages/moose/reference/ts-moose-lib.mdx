...
```ts
// Deprecated: Use getApis and getApi instead
import { getConsumptionApis, getConsumptionApi } from "@514labs/moose-lib";

const apis = getConsumptionApis();  // Same as getApis()
const api = getConsumptionApi("name");  // Same as getApi("name")
```
