...
```ts
import { getViews } from "@514labs/moose-lib";

const views = getViews();  // Returns Map<string, View>
...
```ts
import { getView } from "@514labs/moose-lib";

const view = getView("ActiveUsersView");
if (view) {
