...
<CTACards rows={3} columns={1}>
  <CTACard
    ...
    description="Create a new MooseStack service with a full runtime including OLAP, Streaming, Workflows, and APIs"
  ...
  />
  <CTACard
    title="Add to your existing application"
    description="Add Moose OLAP as a library to your existing app (e.g Next.js, Express, FastAPI, etc.) without adopting a full server runtime"
    ctaLink={PathConfig.addExistingApp.path}
    Icon={PathConfig.addExistingApp.icon}
    variant="default"
    orientation="horizontal"
  />
</CTACards>
...
<StaggeredCard>
 <StaggeredContent
      ...
      cta={{
        label: "Learn more",
        href: PathConfig.dataModeling.path,
        variant: "outline",
      }}
    />
    <StaggeredCode>
...
<StaggeredCards>
  <StaggeredCard className="border-t">
    <StaggeredContent
      ...
      cta={{
        label: "Learn more",
        href: PathConfig.deploying.path,
        variant: "outline",
      }}
    />
    <StaggeredCode>
