...
moose init your-project-name <typescript|python>

# Then import from your database
moose db pull --clickhouse-url <YOUR_CLICKHOUSE_URL>
```
<Callout type="info" title="Review the full guide" href="/moose/getting-started/from-clickhouse" ctaLabel="Get started" compact={true}>
...
Create a blank project, then model your first table:
  ...
  ```
  <Callout type="info" title="Next steps: Model a table" href="/moose/olap/model-table" ctaLabel="Model a table" compact={true}>
