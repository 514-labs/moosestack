...
<Callout type="info" title="Learn more about external tables" ctaLink="/moose/olap/external-tables">
See the [External Tables documentation](/moose/olap/external-tables#development-mode-configuration) for complete configuration options including sample data size and refresh behavior.
</Callout>
