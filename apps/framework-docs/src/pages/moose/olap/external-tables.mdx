...
- **MaterializedViews** that reference external tables
...
4. **MaterializedViews work** because source tables exist

This ensures developers can work on features (like MaterializedViews) even without production database access.
