...
If you don't yet have a Moose project, first initialize it, then use `db pull` to bootstrap models from your existing ClickHouse:

```bash filename="Terminal" copy
# Initialize your project
moose init my-project <typescript|python>
