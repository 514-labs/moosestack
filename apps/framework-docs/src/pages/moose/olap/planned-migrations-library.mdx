...
import { Callout, PathConfig, LanguageSwitcher, TypeScript, Python } from "@/components";
...
If you're using the full MooseStack runtime with `moose prod`, see [How to Use Planned Migrations with Service Model](/moose/olap/planned-migrations) instead.
...
- [How to use planned migrations with service model](/moose/olap/planned-migrations) - For full MooseStack runtime
...
- [Add to existing app guide](/moose/getting-started/add-to-app) - Complete integration guide
