...
<Callout type="info" title="New to Moose migrations?" href="/moose/migrate" ctaLabel="See overview" compact>
Review the migration index first to understand how lifecycle settings interact with deployment models, timing, and planned vs auto-inferred workflows.
</Callout>
