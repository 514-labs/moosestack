...
description: Complete reference for Moose migrations including operations, data types, and plan structure
---
...
This reference documents all migration operations, data types, and plan structures for Moose migrations. Use this as a comprehensive lookup guide when reviewing migration plans, editing YAML files, or understanding schema changes.

<Callout type="info" title="Looking for how-to guides?">
This is a reference document. For step-by-step instructions, see:
- [Local Development](/moose/olap/apply-migrations) - Develop with `moose dev`
- [Server Migrations](/moose/olap/planned-migrations) - Deploy with `moose prod`
- [CLI Migrations](/moose/olap/planned-migrations-library) - Deploy with `moose migrate`
</Callout>
...
- See [troubleshooting schema changes](/moose/olap/schema-change) for details
...
See [lifecycle management](/moose/migrate/lifecycle) for details.

---

## See Also

- [Migration concept guide](/moose/migrate) - Understanding migration modes and models
- [Local development](/moose/olap/apply-migrations) - Develop with auto-inferred migrations
- [Server migrations](/moose/olap/planned-migrations) - Production with service model
- [CLI migrations](/moose/olap/planned-migrations-library) - Production with library model
- [Lifecycle management](/moose/migrate/lifecycle) - Control allowed operations
