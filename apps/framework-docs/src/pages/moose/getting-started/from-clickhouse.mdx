...
# 2. Scan all your tables and their schemas
# 3. Generate TypeScript data models for each table
# 4. Create a complete development environment
...
# 1. Connect to your ClickHouse database
# 2. Scan all your tables and their schemas
# 3. Generate Python data models for each table
# 4. Create a complete development environment
...
<Callout type="info" title="What gets generated">
...
## Connect to your remote ClickHouse
...
- ✅ All your ClickHouse tables converted to code
- ✅ Local development environment running
- ✅ Type-safe data models ready to use
- ✅ Hot-reload enabled for instant development

**Next**: Start building APIs and applications on top of your data!
</Callout>
...
- 🏗️ Creates a local ClickHouse instance with your exact table schemas
- 🔄 Enables hot-reload for instant development
- 📊 Provides a local database for testing and development
- 🚀 Starts a web server for building APIs

<Callout type="info" title="Production Safety">
