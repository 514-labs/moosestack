...
<Callout type="info" title="Alternative: Two-step process" compact={true}>
You can also initialize your project first, then import from your database:
```bash
# Step 1: Initialize your project
moose init my-project typescript  # or python

# Step 2: Import from your database
