...
pub async fn top_command_handler(
    ...
    match commands {
        ...
        Commands::Clean {} => {
            ...
            let devkafka_pid = project_arc
                .project_location
                .join(".moose/native_infra/devkafka.pid");
            let devredis_pid = project_arc
                .project_location
                ...
                || devredis_pid.exists()
            {
                ...
                crate::utilities::native_infra::kill_pid_file(&devkafka_pid);
                crate::utilities::native_infra::kill_pid_file(&devredis_pid);
            }
