...
/**
 * E2E test for Python db-pull with SQL function defaults (ENG-1162)
 *
 * Tests the complete workflow:
 * 1. Create ClickHouse table with DEFAULT expressions using SQL functions
 * 2. Run `moose db-pull` to generate Python code
 * 3. Verify generated Python code has correctly escaped defaults
 ...
 * were incorrectly generated as:
 *   clickhouse_default("\"xxHash64(_id)\"")  # Extra quotes!
 * instead of:
 *   clickhouse_default("xxHash64(_id)")      # Correct
 */
...
describe("Python db-pull with SQL function defaults (ENG-1162)", () => {
  ...
  const TEST_TABLE_NAME = "test_defaults_pull";
  ...
  it("should handle SQL function defaults in db-pull workflow", async function () {
    ...
    console.log("✅ ENG-1162 test passed - bug is fixed!");
  });
