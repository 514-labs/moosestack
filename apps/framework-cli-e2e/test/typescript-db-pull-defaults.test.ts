...
/**
 * E2E test for TypeScript db-pull with SQL function defaults (ENG-1162)
 *
 * Tests the complete workflow:
 * 1. Create ClickHouse table with DEFAULT expressions using SQL functions
 * 2. Run `moose db-pull` to generate TypeScript code
 * 3. Verify generated TypeScript code has correctly formatted defaults
 ...
 *   ClickHouseDefault<"\"xxHash64(_id)\"">  // Extra quotes!
 * instead of:
 *   ClickHouseDefault<"xxHash64(_id)">      // Correct
 */
...
describe("TypeScript db-pull with SQL function defaults (ENG-1162)", () => {
