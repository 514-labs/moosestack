...
<Callout type="info" title="Restart your coding agent">
Once you've confirmed the MooseDev server is running, restart your coding agent (or IDE). This ensures the [MooseDev MCP](https://docs.fiveonefour.com/moosestack/moosedev-mcp) is loaded and your agent has live access to ClickHouse introspection.
</Callout>
