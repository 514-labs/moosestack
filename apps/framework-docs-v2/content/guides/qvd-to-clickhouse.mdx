...
languages: ["python"]
tags: ["Workflows", "ClickHouse"]
---

import { Callout, CTACards, CTACard } from "@/components/mdx";
...
5. Generate table names (e.g., `Item.qvd` → `QvdItem`)
...
<CTACards columns={3}>
  ...
  <CTACard
    ...
    ctaLink="/moosestack/olap-tables"
    ctaLabel="Learn more"
    Icon="Table"
  />
</CTACards>
