...
<ConditionalContent whenId="source-database" whenValue="postgres">
  <VerticalProgressSteps variant="numbered">
    <VerticalProgressSteps.Item title="Set up ClickHouse Cloud ClickPipes">
      [Set up ClickHouse Cloud ClickPipes](#set-up-clickhouse-cloud-clickpipes-postgres-cdc)
      to replicate your Postgres tables into ClickHouse.
    </VerticalProgressSteps.Item>
    <VerticalProgressSteps.Item title="Add MooseStack to your repo">
      [Add MooseStack to your repo](#add-moosestack-to-your-project) and run
      `moose db pull` to generate typed models for the ClickPipes-owned tables.
    </VerticalProgressSteps.Item>
    <VerticalProgressSteps.Item title="Connect Boreal">
      [Connect Boreal](#deploy-your-moosestack-project-to-boreal) so pull
      requests get preview environments and migration plans.
    </VerticalProgressSteps.Item>
    <VerticalProgressSteps.Item title="Migrate one dashboard component">
      [Migrate one dashboard
      component](#migrate-a-dashboard-component-to-clickhouse) using
      ClickHouse-native resources (views, materialized views, serving tables).
    </VerticalProgressSteps.Item>
    <VerticalProgressSteps.Item title="Go to production">
...
<ConditionalContent whenId="source-database" whenValue="sqlserver">
  <VerticalProgressSteps variant="numbered">
    <VerticalProgressSteps.Item title="Add MooseStack to your repo">
      [Add MooseStack to your repo](#add-moosestack-to-your-project) (you’ll
      define the Debezium ingest pipeline in this project).
    </VerticalProgressSteps.Item>
    <VerticalProgressSteps.Item title="Connect Boreal">
      [Connect Boreal](#deploy-your-moosestack-project-to-boreal) so pull
      requests get preview environments and migration plans.
    </VerticalProgressSteps.Item>
    <VerticalProgressSteps.Item title="Prepare your local dev environment">
      [Prepare your local dev
      environment](#prepare-your-local-development-environment) to work with
      ClickHouse.
    </VerticalProgressSteps.Item>
    <VerticalProgressSteps.Item title="Set up Debezium CDC">
      [Set up Debezium CDC](#set-up-change-data-capture-cdc) to stream SQL
      Server changes into ClickHouse via your MooseStack ingest API.
    </VerticalProgressSteps.Item>
    <VerticalProgressSteps.Item title="Migrate one dashboard component">
      [Migrate one dashboard
      component](#migrate-a-dashboard-component-to-clickhouse) using
