...
<Callout type="info" title="Copilot Prompt Context">
...
<Callout type="info" title="Copilot Prompt Context">
Use the checkpoints below as your copilot prompt. Attach the following files as context alongside the prompt:
