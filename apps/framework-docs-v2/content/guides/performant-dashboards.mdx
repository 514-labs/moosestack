...
```
your-monorepo/
├── app/                           # Your Next.js app directory (or similar)
├── components/                    # Your app components
├── moosestack/                    # MooseStack Project ← NEW
│   ├── src/                       # MooseStack source code
│   │   ├── cdc/                   # CDC pipeline code
│   │   ├── models/                # Data Models
│   │   └── queries/               # Query Handlers
│   ├── moose.config.toml          # MooseStack configuration
│   ├── package.json               # MooseStack package config
│   └── tsconfig.json              # TypeScript config for MooseStack
