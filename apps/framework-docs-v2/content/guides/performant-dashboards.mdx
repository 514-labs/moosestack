...
This is designed to be done with AI: you give your copilot the right context and example data for your "golden case" inputs and expected outputs, and it produces the translation and a plan, and you verify correctness at each step—so you get AI speed without scattering one-off ClickHouse SQL across your codebase.
