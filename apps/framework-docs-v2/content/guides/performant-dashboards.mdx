...
<GuideStepper id="performant-dashboards-migration" persist>
  ...
  >
    ...
    <GuideStepper.Checkpoint id="phase-1-checkpoints" title="Run Phase 1 checkpoints">
  ...
  >
    ...
    <GuideStepper.Checkpoint id="phase-2-checkpoints" title="Run Phase 2 checkpoints">
  ...
  >
    ...
    <GuideStepper.Checkpoint id="phase-3-checkpoints" title="Run Phase 3 checkpoints">
