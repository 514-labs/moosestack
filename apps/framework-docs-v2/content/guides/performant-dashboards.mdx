...
<TabbedCode
  ...
  defaultValue="pnpm"
  syncKey="dashboard-migration-starter-kit"
>
  <TabbedCode.Content value="pnpm">
...
```
  ...
  <TabbedCode.Content value="npx">

```bash
npx tiged 514-labs/moose/examples/dashboard-migration moosestack/context
```
...
Make sure you have your local development server running and seeded with sample data from your production ClickHouse database.
</CopilotCallout>
...
- The parity query function from Phase 1 (e.g. `moosestack/app/apis/<handler>.ts`)
