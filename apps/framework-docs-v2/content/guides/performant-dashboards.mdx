...
- **A serving table**: a flattened, pre-joined/pre-computed table designed for reads (your API queries this).
...
<Callout type="tip" title="AI acceleration">
To complete this phase faster with AI assistance, give your copilot this guide section along with your serving table schema from Phase 2.
</Callout>
