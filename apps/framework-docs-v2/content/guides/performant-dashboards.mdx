...
<CustomizePanel
  title="CDC setup"
  description="Use this toggle to show/hide the SQL Server CDC configuration steps."
>
  <CustomizeGrid columns={1}>
    <SelectField
      ...
      label="CDC method"
      options={[
        { value: "debezium", label: "Debezium (SQL Server CDC)" },
        { value: "clickpipes", label: "ClickHouse Cloud ClickPipes" },
      ]}
