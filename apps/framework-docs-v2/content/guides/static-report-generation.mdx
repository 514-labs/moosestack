...
```bash
curl "http://localhost:4000/reports/sales-report-pdf?startDate=2025-01-15&endDate=2025-01-15" > report.pdf
```

You can also filter by region:

```bash
curl "http://localhost:4000/reports/sales-report-pdf?startDate=2025-01-15&endDate=2025-01-15&region=West" > west-report.pdf
```
