...
1. **Exposes a REST endpoint** at `/api/sales-report` - accessible via HTTP GET
...
```bash
curl "http://localhost:4000/api/sales-report?startDate=2025-01-01&endDate=2025-01-31"
```

Filter by region:

```bash
curl "http://localhost:4000/api/sales-report?startDate=2025-01-15&endDate=2025-01-15&region=West"
```
...
async function fetchReportData(
  ...
  const url = `http://localhost:4000/api/sales-report?startDate=${startDate}&endDate=${endDate}`;
...
async function generatePdf(
  ...
  // createPdfKitDocument returns a Promise in newer pdfmake versions
...
1. Check date format uses `YYYY-MM-DD`:
   ```bash
   # Wrong
   curl "http://localhost:4000/api/sales-report?startDate=01-15-2025&endDate=01-31-2025"

   # Correct
   curl "http://localhost:4000/api/sales-report?startDate=2025-01-15&endDate=2025-01-31"
   ```
...
1. Ensure API is accessible:
   ```bash
   curl "http://localhost:4000/api/sales-report?startDate=2025-01-15&endDate=2025-01-15"
   ```
