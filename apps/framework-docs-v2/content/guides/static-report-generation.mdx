...
import { FileTree, CTACards, CTACard, Callout, BulletPointsCard, ToggleBlock, IconBadge } from "@/components/mdx";
...
| `app/apis/salesReport.ts` | Consumption API |
| `scripts/load-file.ts` | CSV/JSON file loader |
| `scripts/generate-pdf-report.ts` | PDF generator |
