...
<BulletPointsCard
  ...
  bullets={[
    ...
    },
    {
      ...
      description: "Date-range queries with filters"
    },
    {
      title: "PDF generator",
      description: "JSON to formatted PDF"
    }
  ]}
/>
...
<BulletPointsCard
  ...
  bullets={[
    ...
    },
    {
      ...
      description: "Use Boreal Cloud for hosting"
    }
  ]}
/>
...
<FileTree>
  <FileTree.Folder name="sales-reports" defaultOpen>
    <FileTree.Folder name="app" defaultOpen>
      <FileTree.File name="index.ts" comment="Export all modules" />
      <FileTree.Folder name="ingest">
        <FileTree.File name="SalesTransaction.ts" comment="IngestPipeline definition" />
      </FileTree.Folder>
      <FileTree.Folder name="views">
        <FileTree.File name="DailySalesSummary.ts" comment="MaterializedView" />
      </FileTree.Folder>
      <FileTree.Folder name="apis">
        <FileTree.File name="salesReport.ts" comment="Consumption API" />
      </FileTree.Folder>
    </FileTree.Folder>
    <FileTree.Folder name="scripts">
      <FileTree.File name="load-file.ts" comment="CSV/JSON file loader" />
      <FileTree.File name="generate-pdf-report.ts" comment="PDF generator" />
    </FileTree.Folder>
    <FileTree.Folder name="sample-data">
      <FileTree.File name="west-store-001.csv" comment="Sample transactions" />
    </FileTree.Folder>
