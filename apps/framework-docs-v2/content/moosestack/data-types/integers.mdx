...
## See Also
- [Floats](/moosestack/data-types/floats) — Floating-point types for approximate numbers
- [Decimals](/moosestack/data-types/decimals) — Fixed-point precision for financial data
