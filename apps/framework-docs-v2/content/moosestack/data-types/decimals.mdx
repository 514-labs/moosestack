...
## See Also
- [Integers](/moosestack/data-types/integers) — When you need whole numbers
- [Floats](/moosestack/data-types/floats) — When approximate precision is acceptable
- [ClickHouse Decimal](https://clickhouse.com/docs/en/sql-reference/data-types/decimal) — ClickHouse official documentation