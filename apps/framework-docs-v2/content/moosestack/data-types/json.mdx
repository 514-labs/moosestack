...
## See Also
- [Nested](/moosestack/data-types/nested) — Fixed-structure embedded objects
- [Maps](/moosestack/data-types/maps) — Key-value pairs with uniform types
- [ClickHouse JSON](https://clickhouse.com/docs/en/sql-reference/data-types/newjson) — ClickHouse official documentation
