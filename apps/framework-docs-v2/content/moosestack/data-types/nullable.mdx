...
<Callout type="warning" title="Nullable performance impact">
...
## See Also
- [ClickHouse Nullable](https://clickhouse.com/docs/en/sql-reference/data-types/nullable) — ClickHouse official documentation
