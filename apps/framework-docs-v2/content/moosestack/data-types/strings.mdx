...
## See Also
- [LowCardinality](/moosestack/data-types/low-cardinality) — Detailed guide for optimizing repeated string values
- [Enums](/moosestack/data-types/enums) — Fixed categorical values
- [ClickHouse String](https://clickhouse.com/docs/en/sql-reference/data-types/string) — ClickHouse official documentation
