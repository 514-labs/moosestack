...
<Callout type="info" title="Boreal Hosting runs this for you">
If you're on **Boreal Hosting** (FiveOneFour’s commercial hosting platform for MooseStack runtime apps), the apply-on-start behavior described here is handled automatically during each deployment. You still need to ship an up-to-date plan, but Boreal ensures the runtime picks it up and runs it safely.
</Callout>
...
- You use Boreal Hosting and want to understand the automatic plan execution it performs on your behalf
