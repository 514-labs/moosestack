...
**Planned migrations** are the production-grade schema evolution mechanism in MooseStack. Unlike [Automatic Migrations](/moosestack/migrate/automatic-migrations), this system separates the *generation* of schema changes from their *execution*, introducing a reviewable artifact (the plan) into your deployment lifecycle.
