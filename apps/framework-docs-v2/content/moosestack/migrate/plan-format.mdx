...
```yaml title="migrations/plan.yaml" copy=false
...
## See Also
- [Migration Modes](/moosestack/migrate/modes) — Overview of the two schema evolution modes in Moose
- [Planned Migrations](/moosestack/migrate/planned-migrations) — Reference documentation for the Planned Migrations system in Moose
- [Lifecycle Management](/moosestack/migrate/lifecycle) — Reference documentation for the Lifecycle Management system in Moose
