...
<Callout type="info" title="Related" compact href="/moosestack/migrate/generate" ctaLabel="Learn more" icon={false}>
Read about how migrations are generated and how to safely evolve your schema in production.
</Callout>
