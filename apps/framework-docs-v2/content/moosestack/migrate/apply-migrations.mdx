...
- [Planned migrations (service model)](/moosestack/migrate/planned-migrations) - For `moose prod` deployments
- [Planned migrations (library model)](/moosestack/migrate/planned-migrations-library) - For existing app integration
...
See [planned migrations (service model)](/moosestack/migrate/planned-migrations) for complete workflow.
...
See [planned migrations (library model)](/moosestack/migrate/planned-migrations-library) for complete workflow.
...
- [Planned migrations (service model)](/moosestack/migrate/planned-migrations) - Production workflow for `moose prod`
- [Planned migrations (library model)](/moosestack/migrate/planned-migrations-library) - Production workflow for existing apps
- [Migration reference](/moosestack/migrate/reference) - Operations, data types, and plan structure
