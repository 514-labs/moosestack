...
| **Version Bumps** | Both | Both modes detect version bumps and prompt for backfill and old-table retention. See [Schema Versioning](/moosestack/olap/schema-versioning). |
