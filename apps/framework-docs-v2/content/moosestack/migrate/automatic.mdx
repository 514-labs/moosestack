...
When the plan contains destructive operations (table drops, column removals, view removals, table recreates), Moose pauses and asks for confirmation before proceeding:
