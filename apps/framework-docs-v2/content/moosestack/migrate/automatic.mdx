...
When the detected changes contain destructive operations (table drops, column removals, view removals, table recreates), Moose pauses and asks for confirmation before proceeding:
