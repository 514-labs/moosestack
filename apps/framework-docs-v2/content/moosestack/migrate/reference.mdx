...
- [Server Migrations](/moosestack/migrate/planned-migrations) - Deploy with `moose prod`
- [CLI Migrations](/moosestack/migrate/planned-migrations-library) - Deploy with `moose migrate`
</Callout>
...
- [Server migrations](/moosestack/migrate/planned-migrations) - Production with service model
- [CLI migrations](/moosestack/migrate/planned-migrations-library) - Production with library model
