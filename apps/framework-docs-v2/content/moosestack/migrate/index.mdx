...
### Getting Started
- [Add Moose to an existing app](/moosestack/getting-started/from-clickhouse) - Library model setup and configuration
- [Quick start guide](/moosestack/getting-started/quickstart) - Service model basics

### Implementation Guides
- [Server migrations](/moosestack/migrate/planned-migrations) - Full MooseStack runtime workflow
- [CLI migrations](/moosestack/migrate/planned-migrations-library) - Existing app integration workflow
- [Dev mode migrations](/moosestack/migrate/apply-migrations) - Using auto-inferred migrations with moose dev
...
### Advanced Topics
- [Lifecycle management](/moosestack/migrate/lifecycle) - Controlling allowed operations
- [Table versioning](/moosestack/olap/schema-versioning) - Blue/green deployments for ORDER BY changes
- [Troubleshooting migrations](/moosestack/migrate/schema-change) - Fixing failed migrations and type mismatches
