...
[Learn more about Auto-Inferred Migrations →](./auto-inferred)
...
[Learn more about Planned Migrations →](./planned-migrations)
...
[Learn more about Lifecycle Management →](./lifecycle)

## Where to Go Next

*   **Just starting out?** Fire up `moose dev` and experience [Auto-Inferred Migrations](./auto-inferred).
*   **Ready to deploy?** Learn how to generate and apply [Planned Migrations](./planned-migrations).
*   **Need to script it?** Check out the [CLI Reference](./apply-planned-migrations-cli) for CI/CD integration.
*   **Something went wrong?** See how to recover from [Failed Migrations](./failed-migrations).
