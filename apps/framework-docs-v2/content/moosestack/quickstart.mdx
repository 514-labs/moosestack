...
<Callout type="info" title="Recommended: Create a virtual environment" icon="Check" compact={true}>
...
1. Open `app/ingest/models.ts` (TypeScript) or `app/ingest/models.py` (Python)
...
<TabsList>
<TabsTrigger value="docker">Docker Issues</TabsTrigger>
<TabsTrigger value="version">Version Issues</TabsTrigger>
<TabsTrigger value="port">Port Conflicts</TabsTrigger>
<TabsTrigger value="permission">Permission Issues</TabsTrigger>
</TabsList>
