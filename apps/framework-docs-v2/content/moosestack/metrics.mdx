...
<Callout type="info" title="Use Up/Down Arrows to Navigate" icon="ArrowUp" compact>
...
<Callout type="info" title="Read the Kubernetes Deployment Guide" href="/moosestack/deploying/deploying-on-kubernetes" ctaLabel="Learn More">
...
<Callout type="success" title="Managed MooseStack in Production" href="https://www.fiveonefour.com/boreal" ctaLabel="Fiveonefour hosting" icon="Cloud">
...
<Callout type="info" title="Join the Community" href="https://join.slack.com/t/moose-community/shared_invite/zt-2fjh5n3wz-cnOmM9Xe9DYAgQrNu8xKxg" ctaLabel="Join Slack" icon="BrandSlack">
