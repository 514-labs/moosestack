...
- **Add LLM-optimized documentation endpoints for AI agents** ([@DatGuyJonathan](https://github.com/DatGuyJonathan))
  ...
  📸 _[Screenshot needed: Added new markdown endpoints that make MooseStack documentation easily accessible to AI agents and LLMs. Users can now append `.md` to any documentation URL to get clean markdown content, and the root `/llm.md` endpoint provides a table of contents for discovery. Also enhanced the documentation UI with a "Copy Page" dropdown menu that lets users copy page content as markdown or open the markdown endpoint directly.]_
