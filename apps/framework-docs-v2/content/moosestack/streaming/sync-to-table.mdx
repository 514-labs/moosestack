...
import { Callout, BulletPointsCard, LanguageTabs, LanguageTabContent, ToggleBlock } from "@/components/mdx";
...
```ts filename="SyncToTable.ts" copy
...
```py filename="SyncToTable.py" copy
...
<Callout type="info" title="Paramters are not configurable" href="https://join.slack.com/t/moose-community/shared_invite/zt-2fjh5n3wz-cnOmM9Xe9DYAgQrNu8xKxg" ctaLabel="Join Slack">
