...
<Tabs defaultValue="ingest-pipeline">
  <TabsList>
    <TabsTrigger value="ingest-pipeline">Ingest Pipeline (Recommended)</TabsTrigger>
    <TabsTrigger value="standalone">Standalone Stream</TabsTrigger>
  </TabsList>
...
<LanguageTabs>
  <LanguageTabContent value="typescript">
```ts filename="StreamObject.ts" copy
interface RawData {
  id: string;
  value: number;
}
...
```
  ...
  <LanguageTabContent value="python">
```py filename="StreamObject.py" copy
...
<Tabs defaultValue="ingest-pipeline-transform">
  <TabsList>
    <TabsTrigger value="ingest-pipeline-transform">Ingest Pipeline (Recommended)</TabsTrigger>
    <TabsTrigger value="standalone-transform">Standalone Stream</TabsTrigger>
  </TabsList>
  <TabsContent value="ingest-pipeline-transform">
<LanguageTabs>
  <LanguageTabContent value="typescript">
...
<Callout type="warning" title="Use getters to get the stream object">
  ...
  <TabsContent value="standalone-transform">
<LanguageTabs>
  <LanguageTabContent value="typescript">
```ts filename="TransformDestinationStream.ts" copy
...
Control how Moose manages your stream resources when your code changes. See the [LifeCycle Management guide](/moosestack/migrate/lifecycle) for detailed information.
...
See the [API Reference](/moosestack/reference/ts-moose-lib#stream) for complete configuration options.
