---
title: Introspect external tables
...
For more on how migrations are generated and what shows up in each migration file, see [Generate migrations](/moosestack/migrate/generate) and the [Migration Plan](/moosestack/migrate/plan-format) reference.
</Callout>
