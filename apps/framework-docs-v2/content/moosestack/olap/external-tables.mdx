...
For more on how migration plans are generated and what shows up in `plan.yaml`, see [/moosestack/migrate/planned-migrations](/moosestack/migrate/planned-migrations).
</Callout>
