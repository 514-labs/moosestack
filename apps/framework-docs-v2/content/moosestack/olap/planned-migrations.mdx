...
|---|---|---|
| `--yes-all` | `MOOSE_ACCEPT_ALL` | Accept all prompts (renames, destructive operations) |
| `--yes-destructive` | `MOOSE_ACCEPT_DESTRUCTIVE` | Accept destructive operations only |
| `--yes-rename` | `MOOSE_ACCEPT_RENAME` | Accept detected column renames only |
