...
```bash filename="Terminal"
moose init your-project-name <template>
cd your-project-name
```

Use `typescript-empty` or `python-empty` for a blank project, or run `moose template list` to see the full template catalog.
