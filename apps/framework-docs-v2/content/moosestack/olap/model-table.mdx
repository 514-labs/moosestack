...
|----------|------|-------------|
| `limit` | `number` / `int` | Default maximum rows to seed for this table. The CLI `--limit` flag overrides it. If neither is set, Moose falls back to the global default of 1000. |
