...
from moose_lib import MaterializedView, LifeCycle, sql
from source_table import source_table
...
import { MaterializedView, LifeCycle } from "@514labs/moose-lib";
...
export const protectedMV = new MaterializedView<TargetSchema>({
  selectStatement: sql`SELECT id, value FROM ${sourceTable}`,
  selectTables: [sourceTable],
