...
MaterializedViews can reference `EXTERNALLY_MANAGED` tables as source tables. To enable this in development mode, configure Moose to automatically create local mirrors:
