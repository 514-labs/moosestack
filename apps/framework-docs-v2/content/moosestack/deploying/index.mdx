...
- Use the [Fiveonefour hosting platform](https://www.fiveonefour.com/boreal) (from the makers of the Moose Stack)

<Callout type="success" title="Deploy on Fiveonefour hosting" href="https://www.fiveonefour.com/boreal" ctaLabel="Learn More" icon="CloudUpload">
...
4. **Serverless Deployment**: Deploy consumption APIs backed by S3/Iceberg tables to AWS Lambda or Google Cloud Run using [`moose build --serverless`](/moosestack/deploying/serverless-deployment)
5. **Offline Server Deployment**: Deploy to an environment without internet access
