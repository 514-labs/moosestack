...
| Typed ClickHouse models + queries in your existing backend | **Embed MooseStack in an existing app** (e.g. [Fastify](/moosestack/getting-started/existing-app/fastify)) |
