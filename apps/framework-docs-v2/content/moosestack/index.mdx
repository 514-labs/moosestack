...
<CTACards rows={4} columns={1}>
  ...
  <CTACard
    ...
    description="Run Moose locally while using ClickHouse Cloud and Redpanda Cloud"
    ctaLink="/moosestack/getting-started/remote-first-quickstart"
    Icon="DeviceLaptop"
    variant="default"
    orientation="horizontal"
  />
