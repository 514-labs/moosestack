...
Type-safe, code-first tooling for building real-time analytical backends in TypeScript or Python—OLAP storage, streaming pipelines, workflows, query APIs, and more.
...
<CTACards rows={3} columns={1}>
  <CTACard
    ...
    description="Start with a small demo app to learn the dev loop"
  ...
  <CTACard
    ...
    description="Start with a reference application for integrating MooseStack with complex microservices architectures"
