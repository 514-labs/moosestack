---
title: Overview
description: Agent harness for building and operating real-time analytical workloads
order: 1
...
MooseStack is an OLAP-native interface and execution environment for AI agents and engineers building analytical workloads.

It turns analytical SDLC into a repeatable development loop: define schemas, materialized views, streams, workflows, and APIs as code, then design, test, validate, and ship with fast feedback and ClickHouse-aware guardrails.
