...
- `/moosestack/olap/model-table/llm.md` — Defaults to typescript
- `/moosestack/olap/model-table/llm.md?lang=python` — Specific language
...
Every doc page has a **Copy Page** button that copies clean markdown to your clipboard — useful for pasting into AI assistants.
