...
// Shared placeholder type for all examples below
type EngineExampleRow = {
  id: string;
  timestamp: Date;
  updated_at: Date;
  deleted: number;
...
const DefaultMergeTree = new OlapTable<EngineExampleRow>("merge_tree_table", {
...
# Shared placeholder model for proven copy/paste
