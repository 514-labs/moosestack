...
export const analyticsView = new View(
  "analytics_events",
...
**Constructor:** `new View(name, selectStatement, baseTables, config?, metadata?)`
...
| `config` | `ViewConfig` (optional) | Configuration options (e.g. `database`) |
