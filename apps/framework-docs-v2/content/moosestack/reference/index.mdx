...
export const analyticsView = new View("analytics_events", {
...
**Constructor:** `new View(name, config)`

| Parameter | Type | Description |
|-----------|------|-------------|
| `name` | `string` | Name of the view |
| `config` | `ViewConfig` | Configuration object (see below) |

**ViewConfig:**

| Field | Type | Description |
|-------|------|-------------|
| `selectStatement` | `string \| Sql` | SELECT SQL defining the view |
| `baseTables` | `(OlapTable \| View)[]` | Source tables/views for dependency tracking |
| `database` | `string` (optional) | ClickHouse database to create the view in. When set, the view is created as `` `database`.`view_name` `` |
