...
| `filters` | `Record<string, ModelFilterDef>` | No | Filterable fields with allowed operators |
| `sortable` | `readonly string[]` | No | Fields that can be sorted |
...
| `identifier(name)` | Quote identifier with backticks |
