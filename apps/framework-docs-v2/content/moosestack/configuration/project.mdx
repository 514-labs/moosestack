...
This reference covers the top-level configuration for your MooseStack project, including language settings, directory structure, telemetry, and git integration.
