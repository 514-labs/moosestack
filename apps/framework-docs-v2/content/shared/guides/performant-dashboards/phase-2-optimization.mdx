...
8. Do not fabricate verification evidence.
9. If optimization validation fails, mark FAIL, report root cause, fix, and re-run.
10. Do not mark PASS until serving tables are populated and query QA passes.
