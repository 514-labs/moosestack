...
<GuideStepper.Checkpoint title="Link your project in Boreal CLI">
Run this from the directory that contains your `moose.config.toml`:

```bash
boreal link
```

This links your local project so Boreal CLI commands run in the right project context.
