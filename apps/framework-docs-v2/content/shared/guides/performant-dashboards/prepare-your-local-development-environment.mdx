...
<GuideStepper.Checkpoint title="Create a new branch and push to trigger preview deploy">
```bash 
git checkout -b <your-branch-name>
git push -u origin <your-branch-name>
```

Create a new branch in your repo to isolate your changes. Pushing the branch triggers a Boreal preview deployment that you can use to validate changes before merging.
