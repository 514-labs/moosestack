...
Once your ClickPipes pipeline is running and you can see replicated tables in ClickHouse Cloud, continue to [**Add MooseStack to your Project and set up Boreal**](#add-moosestack-to-your-project-and-set-up-boreal). In that section, you’ll initialize `moosestack/`, run `moose db pull` to generate typed models for ClickPipes-owned tables, and connect your project to Boreal for preview deployments.
