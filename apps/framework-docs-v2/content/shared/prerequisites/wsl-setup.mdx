...
<Callout type="warning" title="Keep your project files inside WSL, not on /mnt/c">
  ...
  See Microsoft's [Working across file systems](https://learn.microsoft.com/en-us/windows/wsl/filesystems) documentation for more details on degraded cross-filesystem file access performance.
</Callout>
