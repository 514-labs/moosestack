...
Use `514 env get` to retrieve the value of a single user-defined environment variable. For platform-managed variables, use [`514 env list --all`](/hosting/cli/env/list).
