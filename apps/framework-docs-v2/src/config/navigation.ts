...
const moosestackNavigationConfig: NavigationConfig = [
  ...
  { type: "label", title: "Deployment & Lifecycle" },
  {
    ...
    languages: ["typescript", "python"],
    children: [
      { type: "label", title: "Development Workflow" },
      {
        type: "page",
        slug: "moosestack/migrate/apply-migrations",
        title: "Dev Mode Migrations",
        languages: ["typescript", "python"],
      },
      {
        type: "page",
        slug: "moosestack/migrate/schema-change",
        title: "Handling Failed Migrations",
        languages: ["typescript", "python"],
      },
      { type: "separator" },
      { type: "label", title: "Production Workflow" },
      {
        type: "page",
