        ...
        <>
          <div className="mb-2">
            ...
            <p className="text-muted-foreground text-lg">
              A complex blueprint to walk a developer or team of developers
              through how to deliver a solution using fiveonefour products (and
            ...
            <div className="flex flex-col md:flex-row gap-4 rounded-xl border border-border/50 bg-card p-6">
              ...
              <div className="flex flex-col gap-3 flex-1">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 rounded-lg border border-border bg-background px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent hover:text-accent-foreground w-fit"
                >
                  Join
                </Link>
              </div>
