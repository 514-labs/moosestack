...
class OlapConfig(BaseModel):
    ...
    def model_post_init(self, __context):
        ...
        if self.engine:
            from ..blocks import S3Engine, S3QueueEngine, BufferEngine, DistributedEngine, IcebergS3Engine
            ...
            engines_without_sample_by = (S3Engine, S3QueueEngine, BufferEngine, DistributedEngine, IcebergS3Engine)
            ...
            engines_without_partition_by = (S3QueueEngine, BufferEngine, DistributedEngine, IcebergS3Engine)
