...
// Minimal `sql` template-tag stub to keep this example portable.
// In a real app, import `sql` (and your table metadata type) from your SQL/framework library.
declare const sql: (strings: TemplateStringsArray, ...expr: any[]) => unknown;
