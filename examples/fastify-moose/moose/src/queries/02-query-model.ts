...
import { defineQueryModel, InferParams } from "../queryModel";
...
const eventsModel = defineQueryModel({
  ...
  // Fields available in SELECT (can be columns or expressions)
  fields: {
...
// =============================================================================
// Infer the QueryParams type from the model
// =============================================================================

// This gives you fully typed params:
// - filters.amount.gte is `number | undefined`
// - sortBy is `"timestamp" | "amount" | "status" | undefined`
type EventsQueryParams = InferParams<typeof eventsModel>;

// =============================================================================
// Query function using the model
// =============================================================================

async function queryEvents(params: EventsQueryParams): Promise<EventModel[]> {
  return eventsModel.query(params, executeQuery<EventModel>);
}
