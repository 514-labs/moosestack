...
import { defineQueryModel, defineMapper } from "../query-layer";
import { assertValid } from "../query-layer/utils";
...
// =============================================================================
// Define the Mapping (Alternative to QueryBuilder)
// =============================================================================

/**
 * Maps API param names → [filter, operator] or pass-through params.
 *
 * This uses QueryMapper to transform custom API shapes to QueryRequest.
 ...
 */
const mapToQueryRequest = defineMapper<EventsApiParams>()(
  eventsModel,
  {
...
export async function queryEvents(
  ...
  return eventsModel.query(mapToQueryRequest(params), executeQuery<EventModel>);
}
