...
The installation script will install the Moose CLI with version management:
...
```bash
# Moose - version management behavior
bash -i <(curl -sSL https://www.fiveonefour.com/install.sh) moose

# Installing a specific version
bash -i <(curl -sSL https://www.fiveonefour.com/install.sh) moose@1.0.0
...
1. Install version management wrapper
2. Support version-specific installation via flags
3. Handle PATH setup for both interactive and MCP usage
...
- Installation script: Moose version management support
...
1. Basic Wrapper Script:
   ...
   - Support `moose` installation mode
